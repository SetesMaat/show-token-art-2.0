class ShowArt {
	...
	static handleShowArt(altImage) {
		let targetedObject = game.user.targets
		let selectedObject = game.canvas.activeLayer.controlled
		...
		this.checkDuplicates(targetedObject, selectedObject, altImage).forEach(object => {
			...
			const pop = this.createImagePopup(object.actorImage, object.actorTitle)
		})
	}
